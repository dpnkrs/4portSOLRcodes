function error_terms = calculate_error_terms_solr_NonIdeal(freq, S11_S_meas, S11_O_meas, S11_L_meas, S22_S_meas, S22_O_meas, S22_L_meas, S_reciprocal_meas, filepath_S_char, filepath_O_char, filepath_L_char)
...
for i = 1:num_freq
    ...
    % Heuristic for choosing the correct root for t21:
    % Often, the true t21 will have a phase that decreases with frequency (due to delay).
    % For a simple choice, pick the one with the larger real component or smaller phase magnitude.
